...
<template>
  <SidebarProvider class="h-72 overflow-hidden rounded-lg border border-gray-5">
    <SidebarRoot>
      <SidebarContent mobile-title="Workspace navigation" mobile-description="Choose a workspace section">
    ...
    <SidebarInset class="p-4">
      <div class="flex items-center gap-3">
        <SidebarTrigger />
        <p class="text-sm text-gray-11">Below 1024px this opens a modal slideover.</p>
      </div>
    </SidebarInset>
  </SidebarProvider>
</template>
