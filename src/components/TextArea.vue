...
.ui-TextArea[data-resize="vertical"] {
  resize: vertical;
}
.ui-TextArea[data-resize="horizontal"] {
  resize: horizontal;
}
.ui-TextArea[data-resize="both"] {
  resize: both;
}
.ui-TextAreaInput {
...
.ui-TextArea[data-size="1"] {
  min-height: var(--space-8);
  border-radius: var(--radius-2);
}
.ui-TextArea[data-size="1"] .ui-TextAreaInput {
...
.ui-TextArea[data-size="2"] {
  min-height: var(--space-9);
  border-radius: var(--radius-2);
}
.ui-TextArea[data-size="2"] .ui-TextAreaInput {
...
.ui-TextArea[data-size="3"] {
  min-height: 80px;
  border-radius: var(--radius-3);
}
.ui-TextArea[data-size="3"] .ui-TextAreaInput {
...
.ui-TextArea[data-variant="surface"] {
...
.ui-TextArea[data-variant="surface"]:where(:focus-within) {
  --text-area-border-color: var(--focus-a8);
  box-shadow: 0 0 0 2px var(--accent-4), 0 1px 2px 0 rgb(0 0 0 / 0.05);
}
.ui-TextArea[data-variant="surface"] .ui-TextAreaInput::placeholder {
  color: var(--gray-a10);
}
.ui-TextArea[data-variant="surface"] .ui-TextAreaInput:where(:disabled, :read-only) {
  background-image: linear-gradient(var(--gray-a2), var(--gray-a2));
  box-shadow: inset 0 0 0 var(--text-area-border-width) var(--gray-a6);
}
.ui-TextArea[data-variant="soft"] {
  --text-area-border-width: 0px;
  background-color: var(--accent-a3);
  color: var(--accent-12);
}
.ui-TextArea[data-variant="soft"]:where(:focus-within) {
  outline: 2px solid var(--accent-8);
  outline-offset: -1px;
}
.ui-TextArea[data-variant="soft"] .ui-TextAreaInput::selection {
  background-color: var(--accent-a5);
}
.ui-TextArea[data-variant="soft"] .ui-TextAreaInput::placeholder {
  color: var(--accent-12);
  opacity: 0.65;
}
.ui-TextArea[data-variant="soft"] .ui-TextAreaInput:where(:disabled, :read-only) {
  background-image: linear-gradient(var(--gray-a2), var(--gray-a2));
  box-shadow: inset 0 0 0 var(--text-area-border-width) var(--gray-a6);
}
</style>
